 ...
 *
 * dwell — минимальное время показа бита, мс. Основной механизм — в journey.js:
 * при первом проходе вперёд нарисованный прогресс идёт через окно range не
 * быстрее, чем за dwell (колесо при этом не блокируется). Здесь dwell — ещё и
 * запасное удержание текста после range при том же первом проходе.
