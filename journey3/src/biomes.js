...
export const BIOMES = [
  ...
  {
    id: 'forest',
    fog: 0x3c5a34, fogNear: 40, fogFar: 175,
    ...
    sprites: [
      ...
      { t: 'biome_pine_a', x: -27, z: -54, h: 16, layer: 0, dim: 0.66 },
      { t: 'biome_pine_b', x: 22, z: -40, h: 14, layer: 0, dim: 0.72 },
      { t: 'biome_deadtree', x: 4, z: -66, h: 12, layer: 0, dim: 0.60 },
  ...
  },
  {
    ...
    sprites: [
      { t: 'biome_orevein', x: -22, z: -44, h: 24, layer: 0, dim: 0.58 },
      { t: 'biome_orevein', x: 20, z: -40, h: 21, layer: 0, dim: 0.54 },
  ...
  },
  {
    ...
    sprites: [
      ...
      { t: 'haystack', x: 8.4, z: -9, h: 2.3, layer: 2 },
