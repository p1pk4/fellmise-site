...
export const BIOMES = [
  {
    ...
    sprites: [
      ...
      { t: 'hill_green', x: -34, y: 3, z: -68, h: 26, layer: 0, dim: 0.72 },
      { t: 'hill_green', x: 32, y: 2, z: -72, h: 30, layer: 0, dim: 0.66 },
      { t: 'hill_dark', x: -22, y: 1, z: -74, h: 30, layer: 0, dim: 0.48 },
      ...
      { t: 'barn', x: -19, z: -24, h: 7.6, layer: 1 },
      { t: 'haystack', x: -14.5, z: -13, h: 2.4, layer: 2 },
    ...
    boards: [{ key: 'village', kind: 'wood', x: 7.5, z: -26, h: 7.6, ry: -0.22 }],
  },
  {
    id: 'forest',
    ...
    sprites: [
      { t: 'hill_dark', x: -13, y: 3, z: -78, h: 32, layer: 0, dim: 0.34 },
      { t: 'hill_dark', x: 13, y: 3, z: -78, h: 32, layer: 0, dim: 0.34 },
      { t: 'hill_dark', x: -30, y: 2, z: -60, h: 24, layer: 0, dim: 0.40 },
    ...
    boards: [{ key: 'forest', kind: 'wood', x: -8.2, z: -28, h: 7.6, ry: 0.24 }],
  },
  {
    id: 'mine',
    ...
    boards: [
      { key: 'mine_mining', kind: 'wood', x: -7.6, z: -22, h: 7.2, ry: 0.28 },
      { key: 'mine_pvp', kind: 'wood', x: 7.8, z: -28, h: 7.2, ry: -0.28 },
    ],
  },
  {
    id: 'spirit',
    ...
    sprites: [
      { t: 'hill_dark', x: -20, y: 2, z: -58, h: 22, layer: 0, dim: 0.30 },
    ...
    boards: [
      { key: 'spirit_vendetta', kind: 'stone', x: -7.8, z: -25, h: 7.4, ry: 0.26 },
      { key: 'spirit_death', kind: 'stone', x: 8.0, z: -31, h: 7.4, ry: -0.24 },
    ],
  },
  {
    id: 'home',
    ...
    sprites: [
      ...
      { t: 'hill_green', x: -33, y: 3, z: -68, h: 26, layer: 0, dim: 0.62 },
      { t: 'hill_dark', x: 26, y: 2, z: -74, h: 28, layer: 0, dim: 0.44 },
      ...
      { t: 'haystack', x: 11.5, z: -8, h: 2.3, layer: 2 },
    ...
    boards: [{ key: 'home', kind: 'wood', x: 7.0, z: -25, h: 7.2, ry: -0.22 }],
  },
];
