...
TASKS = [
    # The 27th: the audit missed it because gates live in biomes.js, not in
    # layout.json, so "not placed anywhere" read as "on the shelf, fine".
    ("biome_portal", "stone archway portal with a glowing teal magic surface"),
]
