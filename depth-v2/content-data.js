 ...
 *
 * Сколько держится текст биома, эти данные больше не решают: он виден, пока
 * биом визуально текущий (journey.js, TAKEOVER). range остался для двух вещей:
 * начало деревни (первый кадр чистый) и точка, где журнал заранее берёт в
 * память плиту следующей сцены.
